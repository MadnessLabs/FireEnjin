                        ...
                        fs.readFile("./templates/firebaseFunctionsIndex.hbs", "utf8", function (_err, data) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, writeData(location, data
...
exports.default = (function () { return __awaiter(void 0, void 0, void 0, function () {
    var importStr, exportStr, files, _i, files_1, file, pathParts, triggerName, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                importStr = "";
            ...
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, renderIndex("./dist/index.js", importStr, exportStr)];
            case 3:
                _a.sent();
                return [3 /*break*/, 5];
            case 4:
